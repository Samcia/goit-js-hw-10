...
const onInput = (0, _lodashDebounceDefault.default)((evt)=>{
    ...
    (0, _fetchCountries.fetchCountries)(name).then(selectCountry).catch((error)=>console.log(error));
}, DEBOUNCE_DELAY);
...
},{"lodash.debounce":"3JP5n","notiflix":"5z0Oc","./fetchCountries":"fTQqv","./css/styles.css":"1CY4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"1CY4s":[function() {},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
